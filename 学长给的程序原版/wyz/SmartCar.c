...

{
       ...
       switch(P2H&0x1ff)
	    {
		case 0x100: error=-9;worse/=2;    break;
		case 0x180: error=-7;worse/=2;    break;
		case 0x080: error=-6;worse/=2;    break;
		case 0x0c0: error=-5;worse/=2;    break;		
		case 0x040: error=-4;worse/=2;    break;          //left
        ...
        case 0x004: error=4;worse/=2;     break;              
        case 0x006: error=5;worse/=2;     break;       // right
        case 0x002: error=6;worse/=2;     break;            
        case 0x003: error=7;worse/=2;     break;             
        case 0x001: error=9;worse/=2;    break;           
...
void servo_control(void) //舵机控制
{
    ...
    //根据偏差计算舵机角度输出
     servo_PWM = 123+steer_value ;

    if(servo_PWM>=190)      //限幅
        servo_PWM=190;     //防止舵机超过极限值
    if(servo_PWM<=120)
        servo_PWM=120;
